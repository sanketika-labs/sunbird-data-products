...
object CFSummaryReport extends IJob with BaseReportsJob with UserCacheSupport {
  ...
  case class ActivityMetadata(activityId: String, activityType: String, name: String, code: String, primaryCategory: String)

  case class UserActivityInfo(userId: String, cfActivityId: String, clActivityId: String, cfName: String, cfCode: String, clName: String, clCode: String)

  case class CourseInfo(courseId: String, courseName: String, courseCode: String, status: Int)
